...
function compreLaqQuesBean(quesId,langData){
	this.quesId = quesId;
	this.langData = langData;
}

function questions(quesId, quesType, comprehensionId, laqId, laqParentId, correctAnswer, allottedMarks, negMarks, quesKeyPair, keyboardType, typingType, answerType, isCaseSensitive, isEvaluationRequired, quesParam, quesLangBeans, options, hint, testCasePair, paragraphDisplay, programmingSkeletalCode ,alphaWordLimit,storeCandResponse){
	this.quesId = quesId;
	this.quesType = quesType;
...
function secBean(secName,answered,notanswered,marked,markedAndAnswered,isOptional,secType,questions, hasOptionalQuestion,secId,difficultyLevel,diffcultyLabels){
	this.secId = secId;
