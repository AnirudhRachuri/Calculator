...
function fill_line_switcher() {
    ...
    var str = '<br/><center><div id="row1" style="">'+mockVar.typingGroup[mockVar.currentGrp].row1_string+'</div><br/><div class="textAreaDiv" onpaste="return false"><textarea spellcheck="false" id="typedAnswer" onselectstart="return false;" oninput="javascript:checkPasteFF();" onkeydown="copyDataWithEdit(event);" onkeyup="calculateKeyStrokes(event);">'+mockVar.curQuesBean.quesParam.answer+'</textarea></div></center>';
	return str;
}
